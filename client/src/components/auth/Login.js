      ...
      <div className="container">
        <div style={{ marginTop: "4rem" }} className="row">
          <div className="col s8 offset-s2">
            <Link to="/" className="btn-flat waves-effect" style={{color:"black",fontWeight:"bold"}}>
            ...
            <div className="col s12" style={{ paddingLeft: "11.250px" }}>
              ...
              <p className="grey-text text-darken-1" style={{fontWeight:"bold" }}>
            ...
            <form noValidate onSubmit={this.onSubmit}>
              ...
              <div className="input-field col s12">
                ...
                />
                <label htmlFor="password" style={{color:"black",fontSize:15,fontWeight:"bold"}}>Password</label>
                <span className="red-text">
                  {errors.password}
